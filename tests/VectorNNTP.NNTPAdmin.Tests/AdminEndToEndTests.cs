...
public sealed class AdminEndToEndTests : IClassFixture<SharedPgpKeyFixture>
{
    ...
    private IConfiguration BuildConfiguration(int port) =>
        new ConfigurationBuilder().AddInMemoryCollection(new Dictionary<string, string?>
        {
            ...
            ["NntpAdmin:Port"] = port.ToString(System.Globalization.CultureInfo.InvariantCulture),
            ["NntpAdmin:From"] = "newsmaster@usenet.ninja",
            ["NntpAdmin:Pgp:Enabled"] = "true",
            ["NntpAdmin:Pgp:PrivateKeyPath"] = _pgp.Path,
            ["NntpAdmin:Pgp:PrivateKeyPassphrase"] = TestPgpKeys.Passphrase,
