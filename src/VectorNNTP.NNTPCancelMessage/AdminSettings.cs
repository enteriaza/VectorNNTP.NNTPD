...
internal sealed class AdminSettings
{
    ...
    public static bool TryCreate(
        ...
        NntpCancelMessageOptions admin,
        NntpdOptions nntpd,
        ...
        out string error)
    {
        ...
        {
            error = "NNTP host is required (NntpCancelMessage:Host or --host).";
            return false;
        }
        ...
        {
            error = useTls
                ? "TLS was requested but no TLS port is configured (NntpCancelMessage:Port, --port, or Nntpd:BindPortTls)."
                : "NNTP port is required (NntpCancelMessage:Port, --port, or Nntpd:BindPort).";
            return false;
        }
        ...
        {
            error = "NntpCancelMessage:From must be a mailbox address.";
            return false;
        }
        ...
        if (arguments.Cancel)
        {
            ...
            {
                error =
                    "--cancel requires --username/--password or configured NntpCancelMessage:Username/Password " +
