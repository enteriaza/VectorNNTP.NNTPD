...
internal static class AdminCliParser
{
    public static string Usage { get; } =
        """
        NNTPCancelMessage — inspect an article by Message-ID; cancel only with --cancel.

        Usage:
          NNTPCancelMessage [options] <message-id>
          NNTPCancelMessage [options] --cancel <message-id>
          NNTPCancelMessage [options] -cancel <message-id>
        ...
        history. Prefer NntpCancelMessage:Password / Nntpd:NewsmasterPassword via
