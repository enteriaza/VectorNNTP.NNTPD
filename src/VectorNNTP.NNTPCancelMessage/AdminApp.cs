...
internal static class AdminApp
{
    public static async Task<int> RunAsync(
        ...
        INntpCancelMessageTransport? transport = null,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await using var session = transport ?? new TcpNntpCancelMessageTransport();
        try
        {
        ...
        if (settings.HasCredentials)
        {
            ...
            catch (NntpCancelMessageAuthenticationException ex)
            {
