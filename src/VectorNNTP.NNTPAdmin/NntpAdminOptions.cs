...
public sealed class NntpAdminOptions
{
    /// <summary>Configuration section name.</summary>
    public const string SectionName = "NntpAdmin";
...
public sealed class PgpOptions
{
    ...
    /// Prefer <c>NntpAdmin__Pgp__PrivateKeyPassphrase</c> over committing this value.
    /// </summary>
