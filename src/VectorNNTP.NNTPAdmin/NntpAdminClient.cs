...
internal sealed class NntpAdminClient : IAsyncDisposable
{
    ...
    public async Task AuthenticateAsync(string username, string password, CancellationToken cancellationToken)
    {
        ...
        {
            throw new NntpAdminAuthenticationException("AUTHINFO USER failed: " + Encoding.ASCII.GetString(userReply));
        }
        ...
        {
            throw new NntpAdminAuthenticationException("AUTHINFO PASS failed.");
        }
    }
...
internal interface INntpAdminTransport : IAsyncDisposable
{
...
internal sealed class NntpAdminAuthenticationException : IOException
{
    public NntpAdminAuthenticationException(string message)
        : base(message)
    {
    }
}

internal sealed class TcpNntpAdminTransport : INntpAdminTransport
{
    private readonly NntpAdminClient _client = new();
